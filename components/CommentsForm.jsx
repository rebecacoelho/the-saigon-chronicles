...
const CommentsForm = ({ slug }) => {
  ...
  const handleCommentSubmmission = () => {
    setError(false);
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
        ...
        <div className='mt-8'>
            <button type='button' onClick={handleCommentSubmmission} className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-green-700 text-lg rounded-full text-white px-8 py-3 cursor-pointer'>
                Post Comment
            </button>
